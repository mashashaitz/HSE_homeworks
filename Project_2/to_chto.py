...
def show_results():
    ...
    if ids == [] or params == []:
        ...
        for an_id in ids:
            ...
            rows = cur.fetchall()
            tables.append(['id', "answ", rows[0][0], rows[0][1:]])
        return render_template('results_search.html', data=tables)
